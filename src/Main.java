public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Avant traitement : '" + nom.getNomOriginal() + "','"+ nom.getNomTraite() + "'");
        ...
        System.out.println("Avant traitement : '" + nom2.getNomOriginal() + "','"+ nom2.getNomTraite() + "'");
        System.out.println("Après traitement : '" + nom2Traite.getNomNormaliser() + "'");
        System.out.println("Après traitement (faireTraitement) : '" + nom22Traite.getNomNormaliser() + "', '"+ nom2.getNomTraite() +"'");
    }
}