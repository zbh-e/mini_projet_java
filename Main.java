...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i=0;i<resultatSelectionner.size();i++){
            System.out.println(resultatSelectionner.get(i).getNom1().getNomOriginal()+"    ,,,    "+resultatSelectionner.get(i).getNom2().getNomOriginal()+"    ,,,   "+resultatSelectionner.get(i).getScore());
        }
