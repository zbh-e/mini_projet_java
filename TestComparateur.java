public class TestComparateur {
    ...
    public static void main(String[] args) {
        ...
        Nom n1 = new Nom("karim dami", "karim dami");
        Nom n2 = new Nom("mohamed amin rchid", "rchid mohamed amin");
        Nom n3 = new Nom("zied ben hamouda ", "Zeid ben");
        Nom n4 = new Nom(" karim damdam ", "Karim Damdam");
        Nom n5 = new Nom(" karim damdam ", "Karim Damdam");
