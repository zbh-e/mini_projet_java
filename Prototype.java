...
public class Prototype {
    ...
    static void lanceRecherche() {
        ...
        System.out.println(MG + "  1" + R + ". Longueur (différence max 5)");
        System.out.println(MG + "  2" + R + ". Longueur (différence max 10)");
        System.out.println(MG + "  3" + R + ". Tous les candidats");
        System.out.print(GR + "  Choix [1] : " + R);
        ...
        if (choixSel == 2) {
            ...
            System.out.print(GR + "  Nombre de résultats [5] : " + R);
    ...
    static void lanceRechercheParLot() {
        ...
        // Générateur
        System.out.println("\n" + MG + "  1" + R + ". Longueur (diff max 5)");
        System.out.println(MG + "  2" + R + ". Longueur (diff max 10)");
        System.out.println(MG + "  3" + R + ". Tous les candidats");
        System.out.print(GR + "  Choix [1] : " + R);
        int choixGen = lireEntier(1);
    ...
    static GenerateurDesCandidats choisirGenerateur(int choix) {
        switch (choix) {
            case 2:
                return new GenerateurLongeurDeNom(10);
            case 3:
                return new GenerateurLongeurDeNom(Integer.MAX_VALUE);
            case 1:
            default:
                return new GenerateurLongeurDeNom(5);
        }
    }
